...
export function randomRecipe(type, options) {
    const { ingredient: { total: ingredientTotalRange = [3, 6], amount: ingredientAmountRange = [1, 16], } = {}, result: { item: typePool = type, amount: resultAmountRange = [1, 1], prefix = "", suffix = "", lore = [] } = {} } = options ?? {};
